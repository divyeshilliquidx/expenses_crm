...
class Vtiger_Record_Model extends Vtiger_Base_Model {
	...
	public static function getSearchResult($searchKey, $module=false) {
		...
		// $query = 'SELECT crmid, setype FROM vtiger_crmentity INNER JOIN vtiger_contactdetails ON vtiger_contactdetails.contactid = vtiger_crmentity.crmid WHERE vtiger_crmentity.label LIKE ? OR vtiger_contactdetails.email like ?  AND vtiger_crmentity.deleted = 0';
		$query = 'SELECT crmid, setype FROM vtiger_crmentity WHERE vtiger_crmentity.label LIKE ? AND vtiger_crmentity.deleted = 0';
